  ...
  const lessons = [
    {
      ...
      description: "Learn signs for parents and siblings",
      duration: "5 min",
      completed: false,
    ...
    },
    {
      ...
      description: "Signs for aunts, uncles, and cousins",
      duration: "8 min",
      completed: false,
      image: "/family_relationships.png",
    },
    {
      ...
      description: "Expressing family connections",
      duration: "10 min",
      completed: false,
      image: "/family_relationships.png",
    },
    {
      ...
      description: "Signs for family gatherings and events",
      duration: "12 min",
      completed: false,
      image: "/family_relationships.png",
    },
    {
      ...
      description: "Practice family-related conversations",
      duration: "15 min",
      completed: false,
      image: "/family_relationships.png",
    },
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Family & Relationships Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all family-related signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each family sign</p>
                </div>
