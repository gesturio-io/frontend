...
export default function NumbersCountingPage() {
  const lessons = [
    {
      id: 1,
      title: "Numbers 1-5",
      description: "Learn to sign numbers from one to five",
      duration: "5 min",
      completed: true,
      image: "/numbers.jpg",
    },
    {
      id: 2,
      title: "Numbers 6-10",
      description: "Master numbers from six to ten",
      duration: "8 min",
      completed: true,
      image: "/numbers.jpg",
    },
    {
      id: 3,
      title: "Numbers 11-15",
      description: "Learn double-digit numbers",
      duration: "10 min",
      completed: false,
      image: "/numbers.jpg",
    },
    {
      id: 4,
      title: "Numbers 16-20",
      description: "Complete your number knowledge",
      duration: "12 min",
      completed: false,
      image: "/numbers.jpg",
    },
    {
      ...
      description: "Practice counting in sign language",
      duration: "15 min",
      completed: false,
      image: "/numbers.jpg",
    },
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Numbers & Counting</h1>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Numbers & Counting Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all number signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each number sign</p>
                </div>
