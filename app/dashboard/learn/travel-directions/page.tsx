...
export default function TravelDirectionsPage() {
  const lessons = [
    {
      id: 1,
      title: "Basic Directions",
      description: "Learn essential direction signs",
      duration: "5 min",
      completed: false,
      image: "/travel.jpeg",
    },
    {
      ...
      description: "Signs for different modes of transport",
      duration: "8 min",
      completed: false,
      image: "/travel.jpeg",
    },
    {
      ...
      description: "Common travel expressions",
      duration: "10 min",
      completed: false,
      image: "/travel.jpeg",
    },
    {
      ...
      description: "How to ask and understand directions",
      duration: "12 min",
      completed: false,
      image: "/travel.jpeg",
    },
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Travel & Directions</h1>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Travel & Directions Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all travel-related signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each travel sign</p>
                </div>
