...
export default function ColorsDescriptionsPage() {
  const lessons = [
    {
      id: 1,
      title: "Basic Colors",
    ...
    },
    {
      ...
      description: "Mixing and describing colors",
      duration: "8 min",
      completed: false,
      image: "/colors.jpg",
    },
    {
      ...
      description: "Describing people and objects",
      duration: "10 min",
      completed: false,
      image: "/colors.jpg",
    },
    {
      ...
      description: "Expressing dimensions and forms",
      duration: "12 min",
      completed: false,
      image: "/colors.jpg",
    },
    {
      ...
      description: "Combining colors and descriptions",
      duration: "15 min",
      completed: false,
      image: "/colors.jpg",
    },
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Colors & Descriptions</h1>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Colors & Descriptions Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all color and description signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each sign</p>
                </div>
