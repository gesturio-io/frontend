  ...
  const lessons = [
    {
      ...
      description: "Learn common food signs",
      duration: "5 min",
      completed: false,
      image: "/food.jpeg",
    },
    {
      ...
      description: "Essential dining expressions",
      duration: "8 min",
      completed: false,
      image: "/food.jpeg",
    },
    ...
    },
    {
      id: 4,
      title: "Ordering Food",
      description: "How to order in restaurants",
      duration: "12 min",
      completed: false,
      image: "/food.jpeg",
    },
    {
      id: 5,
      title: "Food Conversations",
      description: "Practice food-related dialogues",
      duration: "15 min",
      completed: false,
      image: "/food.jpeg",
    },
  ...
  return (
    <div className="container space-y-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Food & Dining</h1>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Food & Dining Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all food-related signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each food sign</p>
                </div>
