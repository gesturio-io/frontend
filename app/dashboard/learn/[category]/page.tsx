...
export default function CategoryPage({ params }: { params: { category: string } }) {
  ...
  const lessons = [
    ...
    {
      id: 5,
      title: `${categoryName} - Lesson 5`,
      description: "Mastery and review",
      duration: "15 min",
      completed: false,
      image: "/placeholder.svg?height=200&width=300",
    },
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">{categoryName} Vocabulary Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all signs in this category</p>
                </div>
