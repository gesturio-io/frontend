  ...
  const lessons = [
    {
      ...
      description: "Learn to sign the days of the week",
      duration: "5 min",
      completed: false,
      image: "/time.jpg",
    },
    {
      ...
      description: "Master the months in sign language",
      duration: "8 min",
      completed: false,
      image: "/time.jpg",
    },
    {
      id: 3,
      title: "Telling Time",
      description: "Learn to express time and hours",
      duration: "10 min",
      completed: false,
      image: "/time.jpg",
    },
    {
      ...
      description: "Signs for dates and events",
      duration: "12 min",
      completed: false,
      image: "/time.jpg",
    },
    {
      ...
      description: "Common time-related phrases",
      duration: "15 min",
      completed: false,
      image: "/time.jpg",
    },
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Time & Calendar</h1>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Time & Calendar Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all time-related signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each time sign</p>
                </div>
