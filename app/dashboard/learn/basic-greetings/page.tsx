  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-3xl font-bold tracking-tight">Basic Greetings</h1>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium">Basic Greetings Vocabulary Guide</h3>
                  <p className="text-sm text-muted-foreground">Comprehensive reference of all greeting signs</p>
                </div>
              ...
              <div className="flex items-center gap-4 rounded-md border p-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Slow-motion demonstrations of each greeting sign</p>
                </div>
